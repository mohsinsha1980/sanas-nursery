        ...
        <div className="relative z-10 h-full flex items-center pt-16 sm:pt-20 md:pt-24 lg:pt-28">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl">
              <div className="bg-white/80 backdrop-blur-sm text-center md:text-left md:backdrop-blur-none p-4 sm:p-6 lg:p-8 rounded-lg bg-white/55 lg:bg-transparent md:max-w-lg lg:max-w-2xl">
