    ...
    <div key="hero">
      <div className="relative w-full lg:h-[500px]">
        <div className="relative w-full h-[600px] sm:h-[550px] md:h-[500px] lg:h-[550px] xl:h-[550px]">
          ...
          <div className="relative z-10 h-full flex items-center pt-16 sm:pt-20 md:pt-24 lg:pt-24 ">
            <div className="absolute lg:left-[5%] lg:px-0 px-6 ">
              <div className="max-w-4xl">
                <div className="bg-white/80 backdrop-blur-sm text-center md:text-left md:backdrop-blur-none lg:p-0 p-6 rounded-lg lg:bg-transparent md:max-w-lg lg:max-w-2xl ">
