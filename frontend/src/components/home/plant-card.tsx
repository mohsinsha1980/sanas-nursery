...
const PlantCard = ({ plant }: { plant: GreenChoicePlant }) => {
  return (
    ...
    >
      <div className="w-full md:w-[240px] lg:w-[250px] h-[300px] sm:h-[320px] md:h-[350px] lg:h-[375px] rounded-[10px] overflow-hidden transition-transform duration-300 hover:scale-105 px-0">
      ...
      <p className="mt-4 text-center text-lg font-medium text-gray-700 group-hover:text-green-600 transition-colors duration-300">
        {plant.title}
      </p>
    </Link>
  );
