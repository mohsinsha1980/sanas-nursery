      ...
      <div className="max-w-[1200px] w-full   ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-x-6 gap-x-1 lg:gap-y-12 gap-y-5 justify-items-center">
          {plants.map((plant) => (
            ...
            >
              <div className="w-[200px] md:w-[240px] lg:w-[250px] h-[300px] sm:h-[320px] md:h-[350px] lg:h-[375px] rounded-[10px] overflow-hidden transition-transform duration-300 hover:scale-105 group lg:px-0 px-4">
