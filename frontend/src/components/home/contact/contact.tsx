  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate>
      <div className="lg:w-[100%] lg:h-[889px] md:w-[100%] md:h-[900px] w-[100%] h-[950px] flex justify-center items-center bg-[#E4FFF0]     ">
        <div className="contact-form lg:max-w-[61%] lg:min-w-[1000px] lg:h-[667px]  flex justify-center items-center bg-white rounded-xl  ">
          <div className="contact-form-innerdiv lg:max-w-[60%] lg:min-w-[1000px] lg:h-fit md:w-[80%] w-[95%]  lg:gap-y-0 gap-y-10 flex lg:flex-row flex-col justify-between items-center absolute z-10 bg-white md:p-3 lg:px-2 rounded-xl">
            {/* Left Section */}
            ...
            {/* Right Section */}
            <div className="lg:mr-10  lg:w-[50%] lg:h-[500px] md:w-[100%] w-[100%] lg:gap-y-9 gap-y-8 flex flex-col justify-between text-[#8D8D8D] lg:p-0 p-4">
              <div>{error && <p className="text-red-600 mb-5">{error}</p>}</div>
              <div>
                {success && <p className="text-green-600 mb-5">{success}</p>}
              </div>

              <div className=" lg:w-[95%] w-[100%] flex lg:flex-row flex-col justify-between lg:space-y-0 space-y-5">
                <div className="lg:w-[45%] w-[100%] flex flex-col lg:gap-y-2 gap-y-2 ">
