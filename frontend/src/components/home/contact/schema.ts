...
const schema=z.object({
    name:z.string().min(1,"Firstname is required ").min(3,"Firstname should contain atleast 3 charachter").regex(/^[A-Za-z ]+$/, "Name should contain only letters and spaces"),
