          ...
          >
            ...
            <div className="input-div h-fit w-fit  p-0.5 bg-white flex flex-row justify-between lg:rounded-xl md:rounded-xl rounded-[5px] ">
              <input
                ...
                className="lg:w-[260px] md:w-[180px] w-[160px] lg:pl-5 md:pl-2 pl-1 outline-none"
              />
              <button className="p lg:h-[45px] lg:w-[170px] md:h-[35px] md:w-[110px] w-[90px] h-[30px] flex justify-center items-center bg-[#F37521] lg:rounded-xl md:rounded-xl rounded-[5px] text-[#FFFFFF] lg:text-[20px] ">
                Subscribe
              </button>
            </div>
          </div>
