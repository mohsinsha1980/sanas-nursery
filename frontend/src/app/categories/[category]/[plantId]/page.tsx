...
const plants = {
  "fruit-trees": [
    {
      id: "fruit1",
      name: "Mango Tree - Totapuri",
      image: "/plant1.png",
      desc: "A healthy indoor fruit plant.",
    },
    {
      id: "fruit2",
      name: "Natural Plant 2",
      image: "/plant2.png",
      desc: "Perfect for balconies.",
    },
  ],
  "flower-trees": [
    {
    ...
    },
    {
      ...
      desc: "Low maintenance flower tree.",
    },
  ],
};
  ...
  return (
    <>
      ...
      >
        <div
          key="inner-div"
          className="w-[60%] h-[656px] flex  justify-between "
        >
          ...
          <div
            key="four-image-div"
            className="w-[10%] h-full flex flex-col justify-between "
          >
            <Image
              src={plant.image}
              alt={plant.name}
          ...
          <div
            key="content-div"
            className="w-[42%] h-[85%] flex flex-col justify-between items-start "
          >
            <div className="h-fit w-full space-y-2">
              <h1 className="text-[#1D2F33] lg:text-[40px] ">{plant.name}</h1>
              <p className="text-black lg:text-[16px]">
                The Totapuri Mango Tree is a popular variety known for its
                sweet, tangy fruits. Perfect for home gardens and orchards.
              </p>
            </div>
            <div className="h-fit w-full space-y-2">
              <p className="text-black lg:text-[16px]">Key Specifications</p>
              <p className="text-[#505050] lg:text-[16px]">
                Category: Fruit Tree
              </p>
              <p className="text-[#505050] lg:text-[16px]">
            ...
            <button
              type="submit"
              className="p lg:h-fit lg:w-fit pt-4 pb-4 pl-5 pr-5 md:h-[35px] md:w-[110px] w-[90px] h-[30px] flex justify-center items-center hover:bg-[#DA5700]  bg-[#F37521] lg:rounded-xl md:rounded-xl rounded-[5px] text-[#FFFFFF] lg:text-[20px] "
            >
              Enquire on WhatsApp
            </button>
          </div>
