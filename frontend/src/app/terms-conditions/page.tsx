...
export default function TermsConditionsPage() {
  const schemaData = {
    ...
    "@type": "WebPage",
    name: "Terms & Conditions - Sanas Nursery",
    url: "https://sanasnursery.com/terms-conditions",
              ...
              <div className="space-y-6 sm:space-y-8">
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm sm:text-base md:text-lg text-[#475569] space-y-1 sm:space-y-2 ml-4 leading-relaxed">
                    ...
                    <li>
                      ...
                      or provide an online payment facility.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm sm:text-base md:text-lg text-[#475569] space-y-1 sm:space-y-2 ml-4 leading-relaxed">
                    <li>
                      ...
                      to natural differences in plants.
                    </li>
                    <li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-sm sm:text-base md:text-lg text-[#475569] space-y-1 sm:space-y-2 ml-4 leading-relaxed">
                    ...
                    <li>
                      We are not responsible for any payment made to third
                      parties claiming to represent us. Always confirm payment
                      details directly with our official contact.
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-[#fff7ed] p-4 sm:p-6 rounded-lg border-l-4 border-[#f97316]">
                  ...
                  <p className="text-sm sm:text-base md:text-lg text-[#9a3412] leading-relaxed">
                    ...
                    these terms and conditions and agree to be bound by them. If
